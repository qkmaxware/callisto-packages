...
convert -background none -density 300 callisto-logo.svg -resize 128x128 files/usr/share/anaconda/pixmaps/sidebar-logo.png
cp -f anaconda/pixmaps/progress_first.png files/usr/share/anaconda/pixmaps/splash.png
cp -f anaconda/pixmaps/topbar-bg.png files/usr/share/anaconda/pixmaps/topbar-bg.png
...
convert -background none -density 300 callisto-logo.svg -resize 49x49 files/usr/share/icons/hicolor/48x48/apps/anaconda.png
...
convert -background none -density 300 callisto-logo.svg -resize 49x49 files/usr/share/icons/oxygen/48x48/apps/anaconda.png
...
convert -background none -density 300 callisto-logo.svg -resize 128x128 files/usr/share/pixmaps/bootloader/fedora.icns
...
convert -background none -density 300 callisto-logo.svg -resize 128x128 files/usr/share/pixmaps/fedora-logo-small.png
cp -f callisto-logo.svg files/usr/share/pixmaps/fedora-logo-sprite.svg
convert -background none -density 300 callisto-logo.svg -resize 240x240 files/usr/share/pixmaps/fedora-logo.png
convert -background none -density 300 callisto-logo.svg -resize 240x240 files/usr/share/pixmaps/system-logo-white.png
...
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-00.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-01.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-02.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-03.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-04.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-05.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-06.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-07.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-08.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-09.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-10.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-11.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-12.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-13.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-14.png
convert -background none -density 300 callisto-logo.svg -resize 135x135 files/usr/share/plymouth/themes/charge/throbber-15.png
